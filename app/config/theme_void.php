...
return [
    ...
    'views' => [
        [
            ...
            'template' => 'me/header', 
            'data' => [
                'siteTitle' => 'Davids me-sida i PHPMVC',
                'siteTagline' => 'Kmom03 för kursen phpmvc version 2'
            ], 
            'sort' => -1
        ],
        [
    ...
    'data' => [
        ...
        // Stylesheets
        'stylesheets' => ['http://fonts.googleapis.com/css?family=Open+Sans:400,600,700,300,800', 'css/void-base/style.php'],
