...
<div id='wrapper'>
	...
	<?php endif; ?>
<?php if ($this->views->hasContent('banner')) : ?>
	<div class="row content-block content-banner">

		<div id="MainBanner" style=" background-image: url(<?php echo $this->di->request->getBaseUrl() . '/img/banners/'; $this->views->render('banner') ?>);">
			<div id="MainBannerPolygon"></div>
		</div>	
		</div>
	<?php endif; ?>
